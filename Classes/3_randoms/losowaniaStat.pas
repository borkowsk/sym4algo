program LosowaniaIStatystyki; 
{U¿ycie generatora liczb pseudolosowych
do ró¿nych losowañ i badanie co wylosowano.
Histogramy bez grafiki } 

const 
   {Niemal najwiêksza tabela danych jak¹ siê da zadeklarowac w ALGO} 
   LastData=10000; 
   {54200; } 
   {Histogramu tyle ile trzeba} 
   LastHist=100; 
   REALMAX=1.6999999999999999999999e308; 
   REALMIN=-1.6999999999999999999999e308; 
   REALEPS=1.0e-323; 
type 
...
begin 
  writeln(message); 
  {halt; NIE MA W ALGO - ZATRZYMUJEMY PROGRAM WYWO£UJ¥Æ DZIELENIE PRZEZ 0 !!!} 
  writeln(1/0); 
end; 
