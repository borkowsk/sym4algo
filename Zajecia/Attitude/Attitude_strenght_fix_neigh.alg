...
const 
   Rozm=22;  {D³ugoœæ boku agenta} 
   Brzeg=2;  {Obwodka} 
   NajmRoz=2; {Jaki rozmiar maj¹ najslabsi agenci} 
   Bok=30;    {Dlugoœæ boku œwiata} 
   IlePogl¹dów=4; {Liczba konkuruj¹cych pogladów} 
   Gêstoœæ=0.9; {Gêstoœæ zaludnienia} 
   MaxSi³a=1000;{Najwieksza sila - musi byc odpowiednio du¿a do rozk³adu} 
   Rozk³ad=4;   {Stopien rozk³adu "Pareto" >=0 - zero daje brak rozkladu, same MaxSi³a} 
