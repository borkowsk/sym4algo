...
Praktyczne Aspekty Modelowania na UW  i uzupe³niony na zajêciach SPIK
===========================================================================================

  WERSJÊ PIERWSZ¥ WYKONA£A Magda Roszczynska z pomoc¹ Daniela Kamieniarza (ISS zajecia 2006 r)
"Gdy termit nie ma nic na plecach, 
id¹c, sprawdza czy przed nim lub obok niego jest drewienko. 
Je¿eli jest to z pewnym prawdopodobieñstwem go bierze i idzie dalej. 
...
Je¿eli jest to z pewnym prawdopodobieñstwem zrzuca drewienko"
  ...
  ALGORYTM ZLICZANIA DODA£A AGATA TARKA (SPIK zajêcia 2010/11)
"Jeœli mam byæ szczera to korzysta³am ze zbioru znajduj¹cego siê na stronie
http://www.codeproject.com/KB/GDI/QuickFill.aspx
Chcia³am równie¿ zaznaczyæ, ¿e nie do koñca rozumia³am sam kod znajduj¹cy
siê na tej stronie ale obrazki mi du¿o podpowiedzia³y. Zapyta³am siê
równie¿ kolegi z politechniki do czego s³u¿¹ te pop i push bo to nie jest
przecie¿ pascal (C++ u¿ywany jak C). Co do kodu, który mam to ró¿ni siê on
od tego z wikipedii tylko w³asnym stosem na deklarowanej sta³ej tablicy,
nie jest to przesadnie skomplikowane. G³ównie w tej pracy kierowa³am siê
podpowiedzi¹ kolegi ( bo przecie¿ jest to praca dodatkowa), szuka³am
informacji w Internecie, ogl¹da³am wskazówki, wikipediê, Ÿród³a, które
mia³y jakieœ znacznki ^ i niedzia³a³y w algo. Podkreœlam z niczego nie
kopiowa³am wizja nie zaliczenia tego przedmiotu i barku punktów zmotywowa³a
mnie do pracy ?
  Oto inne strony które przegl¹da³am w podpowiedzi na to zadanie:
