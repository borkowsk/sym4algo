...
BEGIN 
  ...
  for i:=1 to 7 do 
    LicznikZmian[i]:=0; 
  assign(out,'zapis_Jagi.txt'); 
  rewrite(out); 
  for i:=1 to 5 do 
    begin 
      writeln(out,'ofiar ',gestosc_of:3:2,', drapie¿ników ',gestosc_drap:3:2,', p1=',p_of_prok:3:2,', p2=',p_drap_zjada:3:2,', p3=',p_drap_prok:3:2,', p4=',p_of_zdycha:3:2,', p5=',p_drap_zdycha:3:2,', p6=',p_drap_glod:3:2); 
      writeln(out,'Ile Ofiar',chr(9),'Ile g³odnych drap',chr(9),'Ile sytych drap',chr(9),'Smierc ofiary',chr(9),'rozmnozenie sie ofiary',chr(9),'smierc drap',chr(9),'rozmnozenie sie drap',chr(9),'zjedzenie ofiary przez drap',chr(9),'zglodnienie drap'); 
      Start(NaszSwiat); 
      N:=0; 
      while N<100 do 
        begin 
