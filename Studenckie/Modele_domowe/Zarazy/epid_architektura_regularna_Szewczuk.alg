Program epidemic ; 
{A one-dimensional regular graph with each node connected to its four adjacent nodes.}
{Dorota Szewczuk}
Type 
   node=record 
        x,y:real; 
...
Var 
   ...
   Const 
   ERatio=0.5; 
   {Ile po³aczeñ istnieje realnie - gdy niewa¿one} 
   Weighted=false; 
