...
Begin 
  ...
  for a:=1 to last-2 do
    {pêtla "id¹ca" od pierwszego wêz³a do ostatniego -2} 
    {pêtla "b"}
    for b:=1 to 2 do 
      {pêtla w pêtli. Ka¿dy s¹siad ma mieæ po dwuch s¹siadów w ka¿d¹ ze stron}
      {wystarczy dorysowywaæ kontakty z s¹siadami zawsze wed³ug wskazówek zegara}
      {w drug¹ stronê nie ma potrzeby poniewa¿ wykonywa³oby siê 2 razy to samo}
      
      begin 
        c:=a+b; 
        {wartoœæ "c" oznacza z którym s¹siadem wêze³ / s¹siad "a" ma siê po³¹czyæ}
        {zwiêkszamy zawsze o wartoœæ z pêtli b z tego powodu, i¿ chcielibyœmy, aby}
        {ka¿dy wêze³ "a" mia³ dwuch (plus b czyli 1 a potem 2) s¹siadów po swojej lewej stronie}
        TheEdges[c,a]:=0.5;{random*random*random; }
        {rysownie kolejnych wêz³ów wa¿onych}
      end; 
  ...
  {program musi teraz dorysowaæ brakuj¹ce wêz³y}
end; 
