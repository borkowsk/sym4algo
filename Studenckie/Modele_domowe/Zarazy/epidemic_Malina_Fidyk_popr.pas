Program Epidemic; 
{Watts and Strogatz's (1998) original SWN (Small Word Network) model, with four rewired edges} 
...
Begin 
  ...
  {Pêtla "daj¹ca" po³¹czenia dooko³a} 
  TheEdges[last,2]:=0.5;{random*random*random; }
  TheEdges[last,1]:=0.5;{random*random*random; }
  TheEdges[16,11]:=0.5;{random*random*random; }
  TheEdges[16,8]:=0.5;{random*random*random; }
  TheEdges[14,5]:=0.5;{random*random*random; }
  TheEdges[6,1]:=0.5;{random*random*random; }
  {Uzupe³nieie po³¹czeñ potrzebnych dla tego typu modelu} 
end; 
