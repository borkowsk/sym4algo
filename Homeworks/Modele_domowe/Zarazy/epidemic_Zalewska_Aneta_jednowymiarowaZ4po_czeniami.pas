Program architektura_sieci ;
{Sieæ a)  Jednowymiarowy  regularny graf, w którym ka¿dy wêze³ jest po³¹czony z 4 s¹siaduj¹cymi wêzlami}
Type
   node=record
        x,y:real;
        state:integer;
...
Begin
  For i:=2 to Last do
    Begin
{ustalanie polaczen miedzy kolejnymi wezlami}
{kazdy laczy sie z 4: 2 przed nim i 2 po nim}
      For j:=i-2 to i-1 do
        If j>0 then
          TheEdges[i,j]:=1;
{uzupelnianie polaczen miedzy wezlami z poczatku a tymi z konca listy}
{czyli zamykanie koleczka}
